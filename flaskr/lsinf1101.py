...
global lsinf1101_exo_subm_min10
lsinf1101_exo_subm_min10 = ()
...
def lsinf1101():
    ...
    if request.args.get('main') is not None:
        ...
        if main == 'exercices_subm':
            if min10 == 'True':
                global lsinf1101_exo_subm_min10
                if len(lsinf1101_exo_subm_min10) == 0:
                    lsinf1101_exo_subm_min10 = exercise_submissions('LSINF1101-PYTHON', 'True')
                exo_subm_data = lsinf1101_exo_subm_min10[1]
                exo_subm_labels = lsinf1101_exo_subm_min10[0]
            else:
                global lsinf1101_exo_subm
