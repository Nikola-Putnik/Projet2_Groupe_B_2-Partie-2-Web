...
global lsinf1252_exo_subm_min10
lsinf1252_exo_subm_min10 = ()
...
def lsinf1252():
    ...
    if request.args.get('main') is not None:
        ...
        if main == 'exercices_subm':
            if min10 == 'True':
                global lsinf1252_exo_subm_min10
                if len(lsinf1252_exo_subm_min10) == 0:
                    lsinf1252_exo_subm_min10 = exercise_submissions('LSINF1252', 'True')
                exo_subm_data = lsinf1252_exo_subm_min10[1]
                exo_subm_labels = lsinf1252_exo_subm_min10[0]
            else:
                global lsinf1252_exo_subm
